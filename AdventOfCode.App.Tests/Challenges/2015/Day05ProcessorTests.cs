...
{
  private readonly Aoc2015Day05Processor _processor;
  public Aoc2015Day05ProcessorTest() : base(2015, 5)
  {
    _processor = new Aoc2015Day05Processor();
  }
  ...
  {
    var result = _processor.MeetsPart1Rules(input);
  ...
  {
    var result = _processor.MeetsPart2Rules(input);
    Assert.Equal(expected, result);
  }
}
