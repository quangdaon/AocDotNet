...
{
    private readonly Aoc2015Day06Processor _processor;

    public Aoc2015Day06ProcessorTest() : base(2015, 6)
    {
        _processor = new Aoc2015Day06Processor();
    }
    ...
    public void ProcessPart1Instruction_GivenMultipleInstructions_IsCumulative()
    {
        ...
        _processor.ProcessPart1Instruction(lights, "turn on 0,0 through 999,0");
        Assert.Equal(1000, GetOnCount(lights));

        _processor.ProcessPart1Instruction(lights, "turn off 0,0 through 499,0");
        Assert.Equal(500, GetOnCount(lights));

        _processor.ProcessPart1Instruction(lights, "toggle 450,0 through 549,0");
        Assert.Equal(500, GetOnCount(lights));
    }
    ...
    public void ProcessPart2Instruction_GivenMultipleInstructions_IsCumulative()
    {
        ...
        _processor.ProcessPart2Instruction(lights, "turn on 0,0 through 999,0");
        Assert.Equal(1000, GetOnCount(lights));

        _processor.ProcessPart2Instruction(lights, "turn off 0,0 through 499,0");
        Assert.Equal(500, GetOnCount(lights));

        _processor.ProcessPart2Instruction(lights, "toggle 450,0 through 549,0");
        Assert.Equal(700, GetOnCount(lights));

        _processor.ProcessPart2Instruction(lights, "turn off 440,0 through 459,0");
